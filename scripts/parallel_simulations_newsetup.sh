...
e=logs/3dplot/dynamic0
mkdir $e

e=logs/3dplot/dynamic4
mkdir $e


for (( t = 1; t <= 4; t++ )); do
g=logs/3dplot/dynamic4/''$t''quad
mkdir $g
  ...
  xmlstarlet ed -P -L\
    ...
    -u 'parameters/beacon_5_en' -v 1 \
    -u 'parameters/beacon_6_en' -v 1 \
    -u 'parameters/beacon_7_en' -v 1 \
    -u 'parameters/beacon_8_en' -v 1 \
   conf/parameters.xml 


  d=logs/3dplot/dynamic4/''$t''quad/beacon

  mkdir $d

   xmlstarlet ed -P -L\
  	-u 'parameters/dynamic_cov_approach' -v 4 \
   conf/parameters.xml 
...
mkdir $g
  ...
  d=logs/3dplot/dynamic0/''$t''quad/beacon

  mkdir $d

   xmlstarlet ed -P -L\
  	-u 'parameters/dynamic_cov_approach' -v 0  \
   conf/parameters.xml 
