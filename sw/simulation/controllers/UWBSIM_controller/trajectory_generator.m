...
trajectoryInfo1 = [0,   0.1,0.1,0,    0,0,0; ... % Initial position
                  0.3/2, -0.1,-0.1,0,  0,0,0; ...
                    
                  12.2/2, -1.45,-1.45,0,  0,0,0; ...
                  12.5/2,   -1.5,-1.5,0,    45,0,0; ...
                  12.8/2, -1.5,-1.45,0  90,0,0; ...
 
                  % 1, -1.5,-0.1,0,  0,0,0; ...
                  18.75/2,   -1.5,0,0,    45,0,0; ...
                   %2.1, -1.5,0.1,0  90,0,0; ...
                  
                  24.7/2, -1.5,1.45,0,  90,0,0; ...
                  25/2,   -1.5,1.5,0,    135,0,0; ...
                  25.3/2, -1.45,1.5,0,  180,0,0; ...
 
                   %3.9, -0.1,1.5,0,  90,0,0; ...
                  31.25/2,   0,1.5,0,    135,0,0; ...
                   %4.1, 0.1,1.5,0,  180,0,0; ...
                  
                  37.2/2, 1.45,1.5,0,  180,0,0; ...
                  37.5/2,   1.5,1.5,0,    225,0,0; ...
                  37.8/2, 1.5,1.45,0,  270,0,0; ...
 
                  % 5.9, 1.5,0.1,0,  180,0,0; ...
                   43.75/2,   1.5,0,0,    225,0,0; ...
                   %6.1, 1.5,-0.1,0,  270,0,0; ...
                  
                  49.7/2, 1.5,-1.45,0,  180,0,0; ...
                  50/2,   1.5,-1.5,0,    225,0,0; ...
                  50.3/2, 1.45,-1.5,0,  270,0,0; ...
                  
                   %7.9, 0.1,-1.5,0,  180,0,0; ...
                  56.25/2,   0,-1.5,0,    225,0,0; ...
                   %8.1, -0.1,-1.5,0,  270,0,0; ...
                  
                  62.2/2, -1.45,-1.5,0,  0,0,0; ...
                  62.5/2,   -1.5,-1.5,0,    45,0,0; ...
                  62.8/2, -1.5,-1.45,0  90,0,0; ...
 
                   %9.9, -1.5,-0.1,0,  0,0,0; ...
                   68.75/2,   -1.5,0,0,    45,0,0; ...
                   %10.1, -1.5,0.1,0  90,0,0; ...
                  
                  74.7/2, -1.5,1.45,0,  90,0,0; ...
                  75/2,   -1.5,1.5,0,    135,0,0; ...
                  75.3/2, -1.45,1.5,0,  180,0,0; ...
 
                   %11, -0.1,1.5,0,  90,0,0; ...
                   81.25/2,   0,1.5,0,    135,0,0; ...
                   %12.1, 0.1,1.5,0,  180,0,0; ...
                  
                  87.2/2, 1.45,1.5,0,  180,0,0; ...
                  87.5/2,   1.5,1.5,0,    225,0,0; ...
                  87.8/2, 1.5,1.45,0,  270,0,0; ...
 
                   %13.9, 1.5,0.1,0,  180,0,0; ...
                   93.75/2,   1.5,0,0,    225,0,0; ...
                   %14.1, 1.5,-0.1,0,  270,0,0; ...
                  
                  99.7/2, 1.5,-1.45,0,  180,0,0; ...
                  100/2,   1.5,-1.5,0,    225,0,0; ...
                  100.3/2, 1.45,-1.5,0,  270,0,0; ...
                  
                   %15.9, 0.1,-1.5,0,  180,0,0; ...
                   106.25/2,   0,-1.5,0,    225,0,0; ...
                   %16.1, -0.1,-1.5,0,  270,0,0; ...
                  
                  112.2/2, -1.45,-1.5,0,  270,0,0; ...
                  112.5/2,   -1.5,-1.5,0,    270,0,0]; % Final position
...
trajectoryInfo2 = [0,   0,0,0,    0,0,0; ... % Initial position
                  ...
                  10.7, -3.5,0,0,  0,0,0; ...
                  11,   -4,0,0,    45,0,0]; % Final position
              
                             % Time, Waypoint, Orientation
trajectoryInfo3 = [0,   0,0,0,    0,0,0; ... % Initial position
                  0.3,  0,0.1,0,  0,0,0; ...
                    
                  10.7, 0,3.5,0,  0,0,0; ...
                  11,   0,4,0,    45,0,0]; % Final position
